...
class ViewController: UIViewController {
  ...
  @IBOutlet weak var frameHieghtSlider: UISlider!
  ...
  @IBOutlet weak var boundsWidthLabel: UILabel!
    ...
    fileprivate func updateSliders() {
        ...
        frameHieghtSlider.maximumValue = Float(superFrame.size.height)
        frameWidthSlider.value = Float(frame.size.width)
        frameHieghtSlider.value = Float(frame.size.height)
